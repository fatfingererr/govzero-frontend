<template>
  ...
  <div class="sidebar-wrapper sidebar-theme">
    <nav ref="menu" id="sidebar">
      ...
      >
        <li class="menu">
          <a href="#home" v-b-toggle class="dropdown-toggle" @click.prevent>
            <div class="">
              <svg
          ...
          <b-collapse id="home" accordion="menu">
            <ul class="collapse submenu list-unstyled show">
              ...
              <router-link tag="li" to="/todo" @click.native="toggleMobileMenu">
                <a>{{ $t("todos") }}</a>
              </router-link>
            </ul>
          </b-collapse>
        ...
        <li class="menu">
          <a href="#treasury" v-b-toggle class="dropdown-toggle" @click.prevent>
            <div class="">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
          ...
          <b-collapse id="treasury" accordion="menu">
            <ul class="collapse submenu list-unstyled show">
              <router-link
                tag="li"
                to="/treasury/overview"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("treasury-overview") }}</a></router-link
              >
            </ul>
          </b-collapse>
        </li>
        <li class="menu">
          ...
          <b-collapse id="community" accordion="menu">
            <ul class="collapse submenu list-unstyled show">
              <router-link
                tag="li"
                to="/community/credits/overview"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("credit-overview") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/community/credits/distribution"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("credit-distribution") }}</a></router-link
              >
            </ul>
          </b-collapse>
        </li>
        <li class="menu">
          ...
          <b-collapse id="governance" accordion="menu">
            <ul class="collapse submenu list-unstyled show">
              <router-link
                tag="li"
                to="/governance/proposals/create"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("create-proposal") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/governance/proposals/voting"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("voting-proposals") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/governance/proposals/finished"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("finished-proposals") }}</a></router-link
              >
            </ul>
          </b-collapse>
        </li>
        <li class="menu">
          ...
          <b-collapse id="contracts" accordion="menu">
            <ul class="collapse submenu list-unstyled show">
              <router-link
                tag="li"
                to="/contracts/credit"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("credit-contract") }}</a></router-link
              >
              <router-link
                tag="li"
                to="/contracts/treasury"
                @click.native="toggleMobileMenu"
                ><a>{{ $t("treasury-contract") }}</a></router-link
              >
            </ul>
          </b-collapse>
        </li>
            ...
            <ul class="collapse submenu list-unstyled show">
              ...
              <li>
                ...
                <b-collapse id="pages-error">
                  ...
                  >
                    <li @click="toggleMobileMenu">
                      <a target="_blank" href="/pages/error404">404</a>
                    </li>
                    <li @click="toggleMobileMenu">
                      <a target="_blank" href="/pages/error500">500</a>
                    </li>
                    <li @click="toggleMobileMenu">
                      <a target="_blank" href="/pages/error503">503</a>
                    </li>
                    <li @click="toggleMobileMenu">
                      <a target="_blank" href="/pages/maintenence"
                        >Maintanence</a
                      >
                    </li>
                  </ul>
        ...
        <li class="menu">
          ...
          <b-collapse id="authentication" accordion="menu">
            <ul class="collapse submenu list-unstyled show">
              ...
              <li @click="toggleMobileMenu">
                <a target="_blank" href="/auth/login">Login Cover</a>
              </li>
              <li @click="toggleMobileMenu">
