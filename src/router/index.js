...
const routes = [
    ...
    },
    {
        path: '/todo',
        name: 'tabs',
        component: () => import(/* webpackChunkName: "components-tabs" */ '../views/home/todo.vue')
    },
    ...
    // Treasury
    {
        ...
        component: () => import(/* webpackChunkName: "components-tabs" */ '../views/treasury/overview.vue')
    },
    
    // Community
    {
        path: '/community/credits/overview',
        name: 'credit-overview',
        component: () => import(/* webpackChunkName: "components-tabs" */ '../views/community/credits/overview.vue')
    },
    {
        path: '/community/credits/distribution',
        name: 'credit-distribution',
        component: () => import(/* webpackChunkName: "components-tabs" */ '../views/community/credits/distribution.vue')
    },
    ...
    // Governance
    {
        ...
        component: () => import(/* webpackChunkName: "components-tabs" */ '../views/governance/proposals/create.vue')
    },
    {
        path: '/governance/proposals/voting',
        name: 'voting-proposals',
        component: () => import(/* webpackChunkName: "components-tabs" */ '../views/governance/proposals/voting.vue')
    },
    {
        path: '/governance/proposals/finished',
        name: 'finished-proposals',
        component: () => import(/* webpackChunkName: "components-tabs" */ '../views/governance/proposals/finished.vue')
    },
