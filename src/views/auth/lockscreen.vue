                                ...
                                <div class="form">
                                    ...
                                    <div class="d-sm-flex justify-content-between">
                                        ...
                                        <div class="field-wrapper">
                                            <b-button type="submit" variant="primary">Unlock</b-button>
                                        </div>
                                    </div>
                                </div>
                            </b-form>
                            <p class="terms-conditions">
                                © 2020 All Rights Reserved. <router-link to="/">CORK</router-link> is a product of dDAO. <a href="javascript:void(0);">Cookie Preferences</a>,
...
<script>
    ...
    export default {
        metaInfo: { title: 'Lockscreen Cover' },
        mounted() {},
        methods: {}
    };
</script>
